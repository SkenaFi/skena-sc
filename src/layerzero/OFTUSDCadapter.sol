 ...
 */
contract OFTUSDCadapter is OFTAdapter, ReentrancyGuard {
    ...
    /**
     * @notice Constructor to initialize the USDC OFT adapter
     * @param _token The address of the USDC token
     ...
     * @return The number of shared decimals (6 for USDC)
     * @dev Overrides OFTAdapter to use USDC's 6 decimals
     */
