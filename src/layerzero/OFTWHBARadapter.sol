...
/**
 * @title OFTWHBARadapter
 * @author Senja Protocol
 * @notice Omnichain Fungible Token adapter for WHBAR cross-chain transfers
 * @dev Extends OFTAdapter for WHBAR with 8 decimals
 * Handles both native chain (295/Hedera) transfers and cross-chain minting/burning
 */
contract OFTWHBARadapter is OFTAdapter, ReentrancyGuard {
    ...
    /// @notice Address of the WHBAR token
    ...
    /**
     * @notice Constructor to initialize the WHBAR OFT adapter
     * @param _token The address of the WHBAR token
     ...
     * @return The number of shared decimals (18 for WHBAR)
     * @dev Overrides OFTAdapter to use WHBAR's 18 decimals
     */
     ...
     * @dev On Hedera (295), transfers existing tokens; on other chains, mints new tokens
     */
     ...
     * @dev On Base (295), locks tokens; on other chains, burns tokens
     */
