 ...
 */
contract OFTWBTCadapter is OFTAdapter, ReentrancyGuard {
    ...
    /**
     * @notice Constructor to initialize the WBTC OFT adapter
     * @param _token The address of the WBTC token
     ...
     * @return The number of shared decimals (8 for WBTC)
     * @dev Overrides OFTAdapter to use WBTC's 8 decimals
     */
