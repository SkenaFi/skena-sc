 ...
 * @notice Omnichain Fungible Token adapter for USDT cross-chain transfers
 * @dev Extends OFTAdapter for USDT with 6 decimals
...
contract OFTUSDTadapter is OFTAdapter, ReentrancyGuard {
    ...
    /**
     * @notice Constructor to initialize the USDT OFT adapter
     ...
     * @return The number of shared decimals (6 for USDT)
     * @dev Overrides OFTAdapter to use USDT's 6 decimals
     */
     ...
     * @dev On Hedera (295), locks tokens; on other chains, burns tokens
     */
