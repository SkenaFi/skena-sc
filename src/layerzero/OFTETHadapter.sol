 ...
 * @notice Omnichain Fungible Token adapter for ETH/WETH cross-chain transfers
 ...
 */
contract OFTETHadapter is OFTAdapter, ReentrancyGuard {
    ...
    /**
     * @notice Constructor to initialize the ETH/WETH OFT adapter
     ...
     * @return The number of shared decimals (18 for ETH/WETH)
