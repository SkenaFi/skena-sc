...
// RUN
// forge test --match-contract SkenaTest -vvv
contract SkenaTest is Test, Helper {
    ...
    // RUN
    // forge test --match-test test_checkorakl --match-contract SkenaTest -vvv
    ...
    // RUN
    // forge test --match-contract SkenaTest --match-test test_swap_collateral -vvv
