...
contract SkenaCoreContracts is Script, Helper {
...
// RUN
// forge script SkenaCoreContracts --broadcast -vvv --verify --verifier etherscan --etherscan-api-key $ETHERSCAN_API_KEY
// forge script SkenaCoreContracts --broadcast -vvv
// forge script SkenaCoreContracts -vvv
